...
@include('sidebar')
    ...
    <div class="container mt-5" id='container'>
        <h1 id='titre' class="mb-4">Gérer les Chantiers</h1>
        ...
        <div class="d-flex justify-content-between mb-3">
            <a href="{{ route('chantiers.create') }}" class="btn btn-primary">Ajouter un Chantier</a>
            <div>
        ...
        <div id="tableView" class="table-responsive custom-table">
            <table class="table table-bordered table-striped " id="chantiersTable" >
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="column-width" style='display:none;'>{{ $chantier->Id }}</td>
                        <td class="column-width">
                                {{ $chantier->Description }}
                        </td>
                        <td class="column-width">{{ $chantier->Code_Chantier }}</td>
                        <td class="column-width">{{ $chantier->Id_Domaine }}</td>
                        <td style='display:flex;gap:10px;'>
                            <a href='{{ route('chantiers.edit', $chantier->Id) }}' class='btn btn-warning'>Edit</a>
                            <form method='post' action='{{ route('chantiers.destroy', $chantier->Code_Chantier) }}'>
                                @csrf
                                @method('delete')
                ...
                <div class="mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"><strong>Code:</strong> {{ $chantier->Code_Chantier }}</p>
        ...
        $(document).ready(function () {
            ...
            $('#chantiersTable').DataTable({
                ...
                "language": {
                    ...
                    "zeroRecords": "Aucun chantier trouvé",
