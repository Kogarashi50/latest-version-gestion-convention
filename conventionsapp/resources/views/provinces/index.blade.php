...
@include('sidebar')
    ...
    <div class="container mt-5" id='container'>
        <h1 id='titre' class="mb-4">Gérer les Provinces</h1>
        ...
        <div class="d-flex justify-content-between mb-3">
            <a href="{{ route('provinces.create') }}" class="btn btn-primary">Ajouter un Province</a>
            <div>
        ...
        <div id="tableView" class="table-responsive custom-table">
            <table class="table table-bordered table-striped " id="communesTable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="column-width" style='display:none;'>{{ $province->Id }}</td>
                        <td class="column-width">
                                {{ $province->Description }}
                        </td>
                        <td class="column-width">
                                {{ $province->Description_Arr }}
                        </td>
                        <td class="column-width">{{ $province->Code }}</td>
                        <td style='display:flex;gap:10px;'>
                            <a href='{{ route('provinces.edit', $province->Id) }}' class='btn btn-warning'>Edit</a>
                            <form method='post' action='{{ route('provinces.destroy', $province->Code) }}'>
                                @csrf
                                @method('delete')
                ...
                <div class="mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"><strong>Code:</strong> {{ $province->Code }}</p>
        ...
        $(document).ready(function () {
            ...
            $('#communesTable').DataTable({
                ...
                "language": {
                    ...
                    "zeroRecords": "Aucun province trouvé",
