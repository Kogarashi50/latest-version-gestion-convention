...
@include('sidebar')
    ...
    <div class="container mt-5" id='container'>
        <h1 id='titre' class="mb-4">Gérer les Programmes</h1>
        ...
        <div class="d-flex justify-content-between mb-3">
            <a href="{{ route('programmes.create') }}" class="btn btn-primary">Ajouter un Programme</a>
            <div>
        ...
        <div id="tableView" class="table-responsive custom-table">
            <table class="table table-bordered table-striped " id="programmesTable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="column-width" style='display:none;'>{{ $programme->Id }}</td>
                        <td class="column-width">
                                {{ $programme->Description }}
                        </td>
                        <td class="column-width">{{ $programme->Code_Programme }}</td>
                        <td class="column-width">{{ $programme->Id_Chantier }}</td>
                        <td style='display:flex;gap:10px;'>
                            <a href='{{ route('programmes.edit', $programme->Id) }}' class='btn btn-warning'>Edit</a>
                            <form method='post' action='{{ route('programmes.destroy', $programme->Code_Programme) }}'>
                                @csrf
                                @method('delete')
                ...
                <div class="mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"><strong>Code Programme:</strong> {{ $programme->Code_Programme }}</p>
                            <p class="card-text"><strong>ID Chantier:</strong> {{ $programme->Id_Chantier }}</p>
        ...
        $(document).ready(function () {
            ...
            $('#programmesTable').DataTable({
                ...
                "language": {
                    ...
                    "zeroRecords": "Aucun programme trouvé",
