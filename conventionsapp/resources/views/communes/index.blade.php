...
@include('sidebar')
    ...
    <div class="container mt-5" id='container'>
        <h1 id='titre' class="mb-4">Gérer les Communes</h1>
        ...
        <div class="d-flex justify-content-between mb-3">
            <a href="{{ route('communes.create') }}" class="btn btn-primary">Ajouter un Commune</a>
            <div>
        ...
        <div id="tableView" class="table-responsive custom-table">
            <table class="table table-bordered table-striped " id="communesTable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="column-width" style='display:none;'>{{ $commune->Id }}</td>
                        <td class="column-width">
                                {{ $commune->Description }}
                        </td>
                        <td class="column-width">
                                {{ $commune->Description_Arr }}
                        </td>
                        <td class="column-width">{{ $commune->Code }}</td>
                        <td style='display:flex;gap:10px;'>
                            <a href='{{ route('communes.edit', $commune->Id) }}' class='btn btn-warning'>Edit</a>
                            <form method='post' action='{{ route('communes.destroy', $commune->Code) }}'>
                                @csrf
                                @method('delete')
                ...
                <div class="mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"><strong>Code:</strong> {{ $commune->Code }}</p>
        ...
        $(document).ready(function () {
            ...
            $('#communesTable').DataTable({
                ...
                "language": {
                    ...
                    "zeroRecords": "Aucun commune trouvé",
