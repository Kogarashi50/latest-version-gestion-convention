...
@include('sidebar')
    ...
    <div class="container mt-5" id='container'>
        <h1 id='titre' class="mb-4">Gérer les Domaines</h1>
        ...
        <div class="d-flex justify-content-between mb-3">
            <a href="{{ route('domaines.create') }}" class="btn btn-primary">Ajouter un Domaine</a>
            <div>
        ...
        <div id="tableView" class="table-responsive custom-table">
            <table class="table table-bordered table-striped " id="domainesTable">
                <thead class="thead-dark">
                    <tr>
                        <th class="column-width" style='display:none;'>Id</th>
                        <th class="column-width">Description</th>
                        <th class="column-width">Description (Arabic)</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="column-width" style='display:none;'>{{ $domaine->Id }}</td>
                        <td class="column-width">
                                {{ $domaine->Description }}
                        </td>
                        <td class="column-width">{{ $domaine->Description_Arr }}</td>
                        <td class="column-width">{{ $domaine->Code_Domaine }}</td>
                        <td style='display:flex;gap:10px;'>
                            <a href='{{ route('domaines.edit', $domaine->Id) }}' class='btn btn-warning'>Edit</a>
                            <form method='post' action='{{ route('domaines.destroy', $domaine->Code_Domaine) }}'>
                                @csrf
                                @method('delete')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title text-primary">
                                    {{ $domaine->Description }} - {{ $domaine->Description_Arr }}
                            </h5>
                            <p class="card-text"><strong>Code:</strong> {{ $domaine->Code_Domaine }}</p>
        ...
        $(document).ready(function () {
            ...
            $('#chantiersTable').DataTable({
                ...
                "language": {
                    ...
                    "zeroRecords": "Aucun domaine trouvé",
