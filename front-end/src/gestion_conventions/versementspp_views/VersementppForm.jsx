                ...
                <Form noValidate onSubmit={handleSubmit}>
                    ...
                    <h5 className="mb-3 mt-4 fw-semibold text-warning border-bottom pb-2">Détails du Versement</h5>
                     <Row className="mb-1 g-3">
                         ...
                         <Form.Group as={Col} md={4} controlId="formMoyenPaiement"><Form.Label className="small mb-1 fw-medium">Moyen de Paiement </Form.Label><Form.Select className={FORM_SELECT_CLASS} name="moyen_paiement" value={formData.moyen_paiement} onChange={handleChange} isInvalid={!!formErrors.moyen_paiement} size="sm"><option value="">-- Sélectionner --</option>{PAIEMENT_METHODE_OPTIONS.map(opt => (<option key={opt.value} value={opt.value}>{opt.label}</option>))}</Form.Select><Form.Control.Feedback type="invalid">{formErrors.moyen_paiement}</Form.Control.Feedback></Form.Group>
                     </Row>
